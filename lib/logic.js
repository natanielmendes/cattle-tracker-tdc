...
function createContract(tx) {
    ...
    contract.farm = factory.newRelationship(NS, 'Company', tx.farm.companyId)
    contract.fridge = factory.newRelationship(NS, 'Company', tx.fridge.companyId)
    contract.createdAt = new Date()
	
    var batch = factory.newResource(NS, 'Batch', 'BATCH_' + Date.now())
    batch.animals = tx.animals
  	
  	var relationship = factory.newRelationship(NS, 'Batch', batch.batchId);

    contract.batch = relationship
